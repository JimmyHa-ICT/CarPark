...
1. Open PC Client in Unity 2021.3.36f. Build the project in Windows Platform.
2. Open MobileClient in Unity 2021.3.36f. Build the project in Android Platform (build .apk file).
